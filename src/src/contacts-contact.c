/* contacts-contact.c generated by valac 0.26.0.27-f1f8, the Vala compiler
...
static void __lambda7_ (ContactsContactPresence* self);
static void ___lambda7__contacts_contact_presence_changed (ContactsContact* _sender, gpointer self);
static void __lambda8_ (ContactsContactPresence* self);
static void ___lambda8__contacts_contact_personas_changed (ContactsContact* _sender, gpointer self);
...
static void __lambda4_ (ContactsContact* self, GeeSet* added, GeeSet* removed);
static void ___lambda4__folks_individual_personas_changed (FolksIndividual* _sender, GeeSet* added, GeeSet* removed, gpointer self);
...
static void __lambda10_ (Block10Data* _data10_, GParamSpec* pspec);
static void ___lambda10__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
static void __lambda11_ (Block10Data* _data10_, GParamSpec* pspec);
...
static gint __lambda13_ (const gchar* a, const gchar* b);
...
static void ___lambda14__contacts_contact_changed (ContactsContact* _sender, gpointer self);
...
static void ___lambda7__contacts_contact_presence_changed (ContactsContact* _sender, gpointer self) {
	__lambda7_ ((ContactsContactPresence*) self);
}
...
static void __lambda9_ (Block9Data* _data9_) {
	...
	self = _data9_->self;
	_tmp0_ = _data9_->contact;
	g_signal_handler_disconnect ((GObject*) _tmp0_, _data9_->id);
	_tmp1_ = _data9_->contact;
	g_signal_handler_disconnect ((GObject*) _tmp1_, _data9_->id2);
}
...
ContactsContactPresence* contacts_contact_presence_construct (GType object_type, ContactsContact* contact) {
	...
	contacts_contact_presence_update_presence_widgets (self);
	_tmp16_ = _data9_->contact;
	_tmp17_ = g_signal_connect_object (_tmp16_, "presence-changed", (GCallback) ___lambda7__contacts_contact_presence_changed, self, 0);
	_data9_->id = _tmp17_;
	_tmp18_ = _data9_->contact;
	_tmp19_ = g_signal_connect_object (_tmp18_, "personas-changed", (GCallback) ___lambda8__contacts_contact_personas_changed, self, 0);
	_data9_->id2 = _tmp19_;
	g_signal_connect_data ((GtkWidget*) self, "destroy", (GCallback) ___lambda9__gtk_widget_destroy, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
...
static void ___lambda4__folks_individual_personas_changed (FolksIndividual* _sender, GeeSet* added, GeeSet* removed, gpointer self) {
	__lambda4_ ((ContactsContact*) self, added, removed);
}
...
ContactsContact* contacts_contact_construct (GType object_type, ContactsStore* store, FolksIndividual* i) {
	...
	g_signal_connect_object (_tmp17_, "personas-changed", (GCallback) ___lambda4__folks_individual_personas_changed, self, 0);
...
gint contacts_contact_compare_fields (void* _a, void* _b) {
	...
	g_warning ("contacts-contact.vala:663: Unsupported AbstractFieldDetails value type");
	result = 0;
	return result;
}
...
static void block10_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data10_->_ref_count_)) {
		ContactsContact* self;
		self = _data10_->self;
		_g_free0 (_data10_->last_class);
		_g_object_unref0 (_data10_->i);
		_g_object_unref0 (_data10_->tp);
		_g_object_unref0 (self);
...
static void __lambda10_ (Block10Data* _data10_, GParamSpec* pspec) {
	...
	_g_free0 (_data10_->last_class);
	_data10_->last_class = _tmp12_;
	_tmp13_ = _data10_->i;
	_tmp14_ = gtk_widget_get_style_context ((GtkWidget*) _tmp13_);
	_tmp15_ = _data10_->last_class;
...
GtkWidget* contacts_contact_create_presence_widget (ContactsContact* self, const gchar* protocol, const gchar* im_address) {
	...
	_data10_->last_class = _tmp14_;
	_tmp15_ = _data10_->i;
	_tmp16_ = gtk_widget_get_style_context ((GtkWidget*) _tmp15_);
	_tmp17_ = _data10_->last_class;
	...
	_tmp22_ = _data10_->tp;
	_tmp23_ = g_signal_connect_data ((GObject*) _tmp22_, "notify::presence-type", (GCallback) ___lambda10__g_object_notify, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
	_data10_->id1 = _tmp23_;
	_tmp24_ = _data10_->tp;
	_tmp25_ = g_signal_connect_data ((GObject*) _tmp24_, "notify::presence-message", (GCallback) ___lambda11__g_object_notify, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
	_data10_->id2 = _tmp25_;
	_tmp26_ = _data10_->i;
	g_signal_connect_data ((GtkWidget*) _tmp26_, "destroy", (GCallback) ___lambda12__gtk_widget_destroy, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
	_tmp27_ = _data10_->i;
...
static GdkPixbuf* contacts_contact_load_icon (ContactsContact* self, GLoadableIcon* file, gint size) {
	...
	if (_tmp0_ != NULL) {
		...
		__catch2_g_error:
		{
			...
			g_warning ("contacts-contact.vala:942: error loading avatar %s\n", _tmp14_);
			_g_error_free0 (e);
		}
		__finally2:
		if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static gint ___lambda13__gcompare_data_func (gconstpointer a, gconstpointer b, gpointer self) {
	gint result;
	result = __lambda13_ ((const gchar*) a, (const gchar*) b);
	return result;
}
...
gchar** contacts_contact_sort_persona_properties (gchar** props, int props_length1, int* result_length1) {
	...
	gchar** _tmp10_ = NULL;
	gint _tmp10__length1 = 0;
	compare_properties = ___lambda13__gcompare_data_func;
	...
	if (_data_->_tmp11_ == ((0 != _tmp10_label0) ? _tmp10_label0 : (_tmp10_label0 = g_quark_from_static_string ("alias")))) {
		...
		switch (0) {
			default:
			{
				...
				g_critical ("contacts-contact.vala:1406: Unknown property '%s' in Contact.set_perso" \
...
static void __lambda14_ (Block11Data* _data11_) {
	...
	self = _data11_->self;
	_tmp0_ = _data11_->callback;
	_tmp0__target = _data11_->callback_target;
	_tmp1_ = _data11_->w;
...
static void __lambda15_ (Block11Data* _data11_) {
	ContactsContact* self;
	self = _data11_->self;
	g_signal_handler_disconnect ((GObject*) self, _data11_->id);
}
...
void contacts_contact_keep_widget_uptodate (ContactsContact* self, GtkWidget* w, GtkCallback callback, void* callback_target, GDestroyNotify callback_target_destroy_notify) {
	...
	_data11_->callback_target = NULL;
	_data11_->callback_target_destroy_notify = NULL;
	_data11_->callback = _tmp2_;
	_data11_->callback_target = _tmp2__target;
	_data11_->callback_target_destroy_notify = callback_target_destroy_notify;
	_tmp3_ = _data11_->callback;
	_tmp3__target = _data11_->callback_target;
	_tmp4_ = _data11_->w;
	_tmp3_ (_tmp4_, _tmp3__target);
	_tmp5_ = g_signal_connect_data (self, "changed", (GCallback) ___lambda14__contacts_contact_changed, block11_data_ref (_data11_), (GClosureNotify) block11_data_unref, 0);
	_data11_->id = _tmp5_;
	_tmp6_ = _data11_->w;
	g_signal_connect_data (_tmp6_, "destroy", (GCallback) ___lambda15__gtk_widget_destroy, block11_data_ref (_data11_), (GClosureNotify) block11_data_unref, 0);
...
GIcon* contacts_contact_get_serializable_avatar_icon (ContactsContact* self) {
	...
	if (_tmp0_) {
		...
		_tmp9_ = self->individual;
		_tmp10_ = folks_avatar_details_get_avatar ((FolksAvatarDetails*) _tmp9_);
		_tmp11_ = _tmp10_;
