/* contacts-view.c generated by valac 0.26.0.27-f1f8, the Vala compiler
...
static void __lambda85_ (Block32Data* _data32_);
...
static void block32_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data32_->_ref_count_)) {
		ContactsView* self;
		self = _data32_->self;
		_g_object_unref0 (_data32_->data);
