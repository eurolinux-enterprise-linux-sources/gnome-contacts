/* contacts-store.c generated by valac 0.26.0.27-f1f8, the Vala compiler
...
static void _contacts_store___lambda19_ (ContactsStore* self, FolksBackend* backend);
static void ___lambda20_ (ContactsStore* self);
static void ____lambda20__folks_backend_persona_store_added (FolksBackend* _sender, FolksPersonaStore* store, gpointer self);
static void ___lambda21_ (ContactsStore* self);
static void ____lambda21__folks_backend_persona_store_removed (FolksBackend* _sender, FolksPersonaStore* store, gpointer self);
static void __contacts_store___lambda19__folks_backend_store_backend_available (FolksBackendStore* _sender, FolksBackend* backend, gpointer self);
static void _contacts_store___lambda22_ (ContactsStore* self, GObject* obj, GParamSpec* pspec);
static gboolean __lambda23_ (ContactsStore* self);
static gboolean ___lambda23__gsource_func (gpointer self);
static void __contacts_store___lambda22__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
static void _contacts_store___lambda24_ (ContactsStore* self, GObject* obj, GParamSpec* pspec);
static gboolean __lambda25_ (ContactsStore* self);
static gboolean ___lambda25__gsource_func (gpointer self);
static void __contacts_store___lambda24__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
static void _contacts_store___lambda26_ (ContactsStore* self, GeeMultiMap* changes);
...
static void __contacts_store___lambda26__folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self);
...
static void block31_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data31_->_ref_count_)) {
		ContactsStore* self;
		self = _data31_->self;
		(_data31_->callback_target_destroy_notify == NULL) ? NULL : (_data31_->callback_target_destroy_notify (_data31_->callback_target), NULL);
		_data31_->callback = NULL;
		_data31_->callback_target = NULL;
		_data31_->callback_target_destroy_notify = NULL;
		_g_object_unref0 (_data31_->matched);
...
static void __lambda16_ (Block31Data* _data31_, ContactsContact* c) {
	...
	self = _data31_->self;
	g_return_if_fail (c != NULL);
	_tmp0_ = _data31_->matcher;
	_tmp0__target = _data31_->matcher_target;
	_tmp1_ = c;
	...
	if (_tmp2_) {
		...
		_g_object_unref0 (_data31_->matched);
		_data31_->matched = _tmp4_;
		_tmp5_ = _data31_->callback;
		_tmp5__target = _data31_->callback_target;
...
static void __lambda18_ (Block31Data* _data31_) {
	...
	void* _tmp0__target = NULL;
	self = _data31_->self;
	_tmp0_ = _data31_->callback;
	_tmp0__target = _data31_->callback_target;
...
static gboolean contacts_store_find_contact_co (ContactsStoreFindContactData* _data_) {
	...
	_data_->_data31_->matcher = _data_->_tmp0_;
	_data_->_data31_->matcher_target = _data_->_tmp0__target;
	_data_->_data31_->_async_data_ = _data_;
	{
		...
		while (TRUE) {
			...
			_data_->_tmp12_ = _data_->_data31_->matcher;
			_data_->_tmp12__target = _data_->_data31_->matcher_target;
			_data_->_tmp13_ = NULL;
	...
	_data_->_data31_->matched = NULL;
	_data_->_data31_->callback = _contacts_store_find_contact_co_gsource_func;
	_data_->_data31_->callback_target = _data_;
	_data_->_data31_->callback_target_destroy_notify = NULL;
	_data_->_tmp17_ = 0UL;
	_data_->_tmp17_ = g_signal_connect_data (_data_->self, "changed", (GCallback) ___lambda16__contacts_store_changed, block31_data_ref (_data_->_data31_), (GClosureNotify) block31_data_unref, 0);
	_data_->id1 = _data_->_tmp17_;
	_data_->_tmp18_ = 0UL;
	_data_->_tmp18_ = g_signal_connect_data (_data_->self, "added", (GCallback) ___lambda17__contacts_store_added, block31_data_ref (_data_->_data31_), (GClosureNotify) block31_data_unref, 0);
	_data_->id2 = _data_->_tmp18_;
	_data_->_tmp19_ = 0UL;
	_data_->_tmp19_ = g_signal_connect_data (_data_->self, "quiescent", (GCallback) ___lambda18__contacts_store_quiescent, block31_data_ref (_data_->_data31_), (GClosureNotify) block31_data_unref, 0);
	...
	_data_->_tmp23_ = NULL;
	_data_->_tmp23_ = _data_->_data31_->matched;
	_data_->_tmp24_ = NULL;
...
static void ____lambda20__folks_backend_persona_store_added (FolksBackend* _sender, FolksPersonaStore* store, gpointer self) {
	___lambda20_ ((ContactsStore*) self);
}
...
static void _contacts_store___lambda19_ (ContactsStore* self, FolksBackend* backend) {
	...
	if (g_strcmp0 (_tmp2_, "eds") == 0) {
		...
		_tmp3_ = backend;
		g_signal_connect_object (_tmp3_, "persona-store-added", (GCallback) ____lambda20__folks_backend_persona_store_added, self, 0);
		_tmp4_ = backend;
		g_signal_connect_object (_tmp4_, "persona-store-removed", (GCallback) ____lambda21__folks_backend_persona_store_removed, self, 0);
	}
}


static void __contacts_store___lambda19__folks_backend_store_backend_available (FolksBackendStore* _sender, FolksBackend* backend, gpointer self) {
	_contacts_store___lambda19_ ((ContactsStore*) self, backend);
}
...
static gboolean ___lambda23__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda23_ ((ContactsStore*) self);
	return result;
}
...
static void __contacts_store___lambda22__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_contacts_store___lambda22_ ((ContactsStore*) self, _sender, pspec);
}
...
static gboolean ___lambda25__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda25_ ((ContactsStore*) self);
	return result;
}
...
static void __contacts_store___lambda24__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_contacts_store___lambda24_ ((ContactsStore*) self, _sender, pspec);
}
...
static void __contacts_store___lambda26__folks_individual_aggregator_individuals_changed_detailed (FolksIndividualAggregator* _sender, GeeMultiMap* changes, gpointer self) {
	_contacts_store___lambda26_ ((ContactsStore*) self, changes);
}
...
static GObject * contacts_store_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	g_signal_connect_object (_tmp4_, "backend-available", (GCallback) __contacts_store___lambda19__folks_backend_store_backend_available, self, 0);
	_tmp5_ = folks_individual_aggregator_dup ();
	_tmp6_ = _tmp5_;
	contacts_store_set_aggregator (self, _tmp6_);
	_g_object_unref0 (_tmp6_);
	_tmp7_ = self->priv->_aggregator;
	g_signal_connect_object ((GObject*) _tmp7_, "notify::is-quiescent", (GCallback) __contacts_store___lambda22__g_object_notify, self, 0);
	_tmp8_ = self->priv->_aggregator;
	g_signal_connect_object ((GObject*) _tmp8_, "notify::is-prepared", (GCallback) __contacts_store___lambda24__g_object_notify, self, 0);
	_tmp9_ = self->priv->_aggregator;
	g_signal_connect_object (_tmp9_, "individuals-changed-detailed", (GCallback) __contacts_store___lambda26__folks_individual_aggregator_individuals_changed_detailed, self, 0);
