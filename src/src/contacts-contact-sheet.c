/* contacts-contact-sheet.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
void contacts_contact_sheet_update (ContactsContactSheet* self, ContactsContact* c) {
	...
	_tmp8_ = _data16_->c;
	_tmp9_ = image_frame;
	contacts_contact_keep_widget_uptodate (_tmp8_, (GtkWidget*) _tmp9_, ___lambda29__gtk_callback, block16_data_ref (_data16_), block16_data_unref);
	_tmp10_ = image_frame;
	...
	_tmp18_ = _data16_->c;
	_tmp19_ = name_label;
	contacts_contact_keep_widget_uptodate (_tmp18_, (GtkWidget*) _tmp19_, ___lambda30__gtk_callback, block16_data_ref (_data16_), block16_data_unref);
	_tmp20_ = name_label;
	...
	personas = _tmp22_;
	{
		...
		while (TRUE) {
			...
			if (!_tmp34_) {
				...
				_tmp43_ = store_name;
				gtk_label_set_xalign (_tmp43_, 0.0f);
				_tmp44_ = store_name;
			...
			if (_tmp51_ != NULL) {
				...
				emails = _tmp55_;
				{
					...
					while (TRUE) {
						...
						button = _tmp76_;
						_tmp77_ = button;
						g_signal_connect_data (_tmp77_, "clicked", (GCallback) ________lambda31__gtk_button_clicked, block17_data_ref (_data17_), (GClosureNotify) block17_data_unref, 0);
			...
			if (_tmp80_ != NULL) {
				...
				phones = _tmp84_;
				{
					...
					while (TRUE) {
						...
						_data18_->phone = (FolksPhoneFieldDetails*) _tmp95_;
						...
						if (_tmp99_) {
							...
							button = _tmp109_;
							_tmp110_ = button;
							g_signal_connect_data (_tmp110_, "clicked", (GCallback) _________lambda32__gtk_button_clicked, block18_data_ref (_data18_), (GClosureNotify) block18_data_unref, 0);
							_g_object_unref0 (button);
						} else {
			...
			if (_tmp121_ != NULL) {
				{
					...
					while (TRUE) {
						...
						_data19_->protocol = (gchar*) _tmp132_;
						{
							...
							while (TRUE) {
								...
								_data20_->id = (FolksImFieldDetails*) _tmp144_;
								_tmp145_ = p;
								if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp145_, TPF_TYPE_PERSONA)) {
									...
									button = _tmp153_;
									_tmp154_ = button;
									g_signal_connect_data (_tmp154_, "clicked", (GCallback) ___________lambda33__gtk_button_clicked, block20_data_ref (_data20_), (GClosureNotify) block20_data_unref, 0);
									_g_object_unref0 (button);
								}
								block20_data_unref (_data20_);
								_data20_ = NULL;
			...
			if (_tmp212_ != NULL) {
				FolksPostalAddressDetails* _tmp240_ = NULL;
				GeeSet* _tmp241_ = NULL;
				GeeSet* _tmp242_ = NULL;
				gint _tmp243_ = 0;
				gint _tmp244_ = 0;
				{
				...
				_tmp240_ = addr_details;
				_tmp241_ = folks_postal_address_details_get_postal_addresses (_tmp240_);
				_tmp242_ = _tmp241_;
				_tmp243_ = gee_collection_get_size ((GeeCollection*) _tmp242_);
				_tmp244_ = _tmp243_;
				if (_tmp244_ > 0) {
					ContactsAddressMap* map = NULL;
					ContactsContact* _tmp245_ = NULL;
					FolksPostalAddressDetails* _tmp246_ = NULL;
					GeeSet* _tmp247_ = NULL;
					GeeSet* _tmp248_ = NULL;
					ContactsAddressMap* _tmp249_ = NULL;
					ContactsAddressMap* _tmp250_ = NULL;
					ContactsAddressMap* _tmp251_ = NULL;
					gint _tmp252_ = 0;
					gint _tmp253_ = 0;
					_tmp245_ = _data16_->c;
					_tmp246_ = addr_details;
					_tmp247_ = folks_postal_address_details_get_postal_addresses (_tmp246_);
					_tmp248_ = _tmp247_;
					_tmp249_ = contacts_address_map_new (_tmp245_, _tmp248_);
					g_object_ref_sink (_tmp249_);
					map = _tmp249_;
					_tmp250_ = map;
					contacts_address_map_load (_tmp250_);
					_tmp251_ = map;
					_tmp252_ = i;
					gtk_grid_attach ((GtkGrid*) self, (GtkWidget*) _tmp251_, 1, _tmp252_, 1, 1);
					_tmp253_ = i;
					i = _tmp253_ + 1;
			...
			_tmp255_ = i;
			_tmp256_ = last_store_position;
			if (_tmp255_ == _tmp256_) {
				gint _tmp257_ = 0;
				GtkWidget* _tmp258_ = NULL;
				_tmp257_ = i;
				_tmp258_ = gtk_grid_get_child_at ((GtkGrid*) self, 0, _tmp257_ - 1);
				gtk_widget_destroy (_tmp258_);
			}
