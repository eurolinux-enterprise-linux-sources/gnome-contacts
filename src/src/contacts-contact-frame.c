/* contacts-contact-frame.c generated by valac 0.34.0.3-63fa6, the Vala compiler
...
static void ___lambda28_ (ContactsContactFrame* self);
...
static void ____lambda28__gtk_button_clicked (GtkButton* _sender, gpointer self) {
	___lambda28_ ((ContactsContactFrame*) self);
}
...
ContactsContactFrame* contacts_contact_frame_construct (GType object_type, gint size, gboolean with_button) {
	...
	if (_tmp5_) {
		...
		_tmp16_ = button;
		g_signal_connect_object (_tmp16_, "clicked", (GCallback) ____lambda28__gtk_button_clicked, self, 0);
		_tmp17_ = button;
